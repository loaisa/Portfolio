...
const Projects = () => {
    const projects = [
        ...
        {title: 'PostLearn', description: 'PostLearn - это веб-приложение, позволяющее пользователям создавать, публиковать и взаимодействовать с образовательным контентом. Платформа поддерживает функции социальных медиа, такие как лайки и комментарии, а также включает систему тегов для категоризации контента',
            url: 'https://friends-posts.netlify.app/'},
